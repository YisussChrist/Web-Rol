    const PAGES = [
      ...
      { title: "Inazuma Central", category: "Inazuma Eleven", emoji: "🏟️", url: "centro-inazuma.html?v=5", description: "Centro deportivo de jugadores, equipos, técnicas, estadísticas y temporada.", status: "" },
      { title: "InaMarkt", category: "Inazuma Eleven", emoji: "📈", url: "InaMarkt/index.html", description: "Valores de mercado, rankings de jugadores, clubes y operaciones del fútbol Inazuma.", status: "" },
      ...
      { title: "Normativa de Héroe", category: "Dragon Ball", emoji: "📜", url: "codigo_general_heroes.html", description: "Reglamento oficial de los héroes del universo Dragon Ball.", status: "Nuevo" },

      { title: "Pokémon Center", category: "Pokémon", emoji: "🏥", url: "Pokemon/center.html", description: "Centro regional con entrenadores, equipos, especies, medallas, mapa y herramientas de Etruria.", status: "" },
      ...
      { title: "Pokédex de Etruria", category: "Pokémon", emoji: "◉", url: "Pokemon/pokedex.html", description: "Registro regional de especies, habilidades, estadísticas y movimientos.", status: "" },
      { title: "Laboratorio de Equipo", category: "Pokémon", emoji: "⚗", url: "Pokemon/equipo.html", description: "Crea el equipo de un personaje y estudia evoluciones, potencial, movimientos y objetos antes de guardarlo.", status: "" },
      ...
      { title: "Bolos", category: "General", emoji: "🎳", url: "bolos.html", description: "Calculadora de una partida de bolos.", status: "" },
      ...
      { title: "Calendario Conectado", category: "General", emoji: "📆", url: "calendario.html", description: "Agenda de cumpleaños, aniversarios, sesiones y acontecimientos de los servidores.", status: "" },
      { title: "Relaciones 2.0", category: "General", emoji: "💖", url: "relaciones.html", description: "Mapa narrativo de personajes, vínculos, estados y evolución de relaciones.", status: "" },
      ...
      { title: "Equipo Ideal", category: "Minijuegos", emoji: "⚽", url: "juegos/equipo.html", description: "Construye un once con personajes del RP, asigna posiciones y guarda tu alineación.", status: "" },
